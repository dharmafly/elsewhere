...
function Grapher (url, options) {
  ...
  this.options.logging = this.options.logging !== undefined ? this.options.logging : true;
}
...
Grapher.prototype = {
  ...
  build: function (callback) {
    if (this.options.logging) this.logFetching();
  ...
  fetchPages: function (callback) {
    ...
    whenFetched = function () {
      if (self.options.logging) self.logFetched();
  ...
  toJSON: function () {
    ...
    if (self.options.logging) self.logRendered(rtnObj);
